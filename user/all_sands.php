...
<?php
  // Check if the booking was successful
  if (isset($_SESSION['order_success1']) && $_SESSION['order_success1'] == true) {
      // Display Swal2 toast for successful booking
      echo '<script>
...
<?php
  // Check if the booking was successful
  if (isset($_SESSION['empty_fields1']) && $_SESSION['empty_fields1'] == true) {
      // Display Swal2 toast for successful booking
      echo '<script>
      Swal.fire({
        position: "center",
...
?>
        <li>  
            <div class="featured-car-card">
                <a href="view_sand.php?id=<?php echo  $row['id']; ?>&user_id=<?php echo $_SESSION['user_id']; ?>">
