            ...
            <div class="form-group" id="bansud_barangay" style="display:none;">
                ...
                <select class="form-control" class="barangay" id="bansud" required name="barangay" style="background: transparent; border: none; border-bottom: 1px solid #3B3E4B; border-radius: 1px !important; text-align: center; font-size: 1rem;">
...
<option value="Villa Pag-asa" style="background:white;">Villa Pag-asa</option>
            ...
            <div class="form-group"  id="gloria_barangay" style="display:none;">
                <label for="municipality" class="col-form-label">Barangay</label>
                
                <select class="form-control" class="barangay" id="gloria" name="barangay" style="background: transparent; border: none; border-bottom: 1px solid #3B3E4B; border-radius: 1px !important; text-align: center; font-size: 1rem;">
                <option disabled selected hidden>Choose..</option>
...
<option value="Tambong" style="background:white;">Tambong</option>
            ...
            <div class="form-group" id="pinamalayan_barangay" style="display:none;">
                <label for="municipality" class="col-form-label">Barangay</label>
                <select class="form-control" class="barangay" id="pinamalayan" name="barangay" style="background: transparent; border: none; border-bottom: 1px solid #3B3E4B; border-radius: 1px !important; text-align: center; font-size: 1rem;">
