<div class="col-md-6 col-lg-3" id="yearly_revenue" style="display:none;">
					<div class="card">
						<div class="card-body">
							<div class="row">
  ...
  echo '<span class="' . $class . ' small pt-1 fw-bold" id="rent_percentage_year" style="color:black; float:right; margin-top:9%; font-size:0.8rem;">'. $sign . abs($percentage_change) . '%</span>';
  // Display the total revenue for the current year
  echo '<h5 id="rent_sales_year" style="font-size:1.1rem;">₱' . number_format($total_revenue_current_year, 0) . '</h5>';
