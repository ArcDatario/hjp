<div class="col-md-6 col-lg-3" id="monthly_orders_revenue" style="display:none;">
					<div class="card">
						<div class="card-body">
							<div class="row">
  ...
  echo '<span class="' . $class . ' small pt-1 fw-bold" style="color:black; float:right; margin-top:9%; font-size:0.8rem;" id="orders_percentage_month">'. $sign . abs($percentage_change) . '%</span>';
