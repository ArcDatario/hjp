...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($updateEquipmentSql) === TRUE) {
        ...
        $getEmailSql = "SELECT rental.equipment_id as id_equipment, rental.user_email, rental.summary, rental.total, rental.rent_start_date, rental.rent_end_date, equipment_tbl.image ,equipment_tbl.equipment  
                FROM rental 
