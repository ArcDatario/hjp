...
<body>
  ...
  <div class="topbar transition">
	...
	<div class="sidebar transition overlay-scrollbars animate__animated  animate__slideInLeft">
        <div class="sidebar-content"> 
            ...
            <ul class="side-menu">
				...
				<li>
					<a href="completed_orders.php" class="active">
					<i class='bx bx-list-ul icon'></i>
						Completed Orders
					</a>
				</li>
    ...
    // Corrected query with error handling
    $sql = "
        SELECT 
        ...
        WHERE TRIM(orders.status) = 'Completed'
    ";
    ...
    if (!$result) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['sand']); ?></td>
                <td><?php echo htmlspecialchars($row['summary']); ?></td>
                <td>₱<?php echo htmlspecialchars($row['total']); ?></td>
                <td><span style="color:#138618;"><?php echo htmlspecialchars($row['status']); ?></span></td>
                <td><?php echo htmlspecialchars($row['user_name']); ?></td>
                <td><?php echo htmlspecialchars($row['phone']); ?></td>
                <td><?php echo htmlspecialchars($row['barangay']) . ", " . htmlspecialchars($row['municipality']); ?></td>
                <td><?php echo htmlspecialchars($row['details']); ?></td>
            </tr>
            <?php
        }
    } else {
        // If no rows match the query, display this message
    ...
    Swal.fire({
        title: 'Are you sure?',
        text: 'You are about to Complete this Order. #' + orderId ,
        icon: 'success',
