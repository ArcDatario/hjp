...
$percentage_html = '<span class="' . $class . ' small pt-1 fw-bold" id="orders_percentage_year" style="color:black; float:right; margin-top:9%; font-size:0.8rem;">'. $sign . abs($percentage_change) . '%</span>';
$total_revenue_html = '<h5 id="orders_sales_year" style="font-size:1.1rem;">₱' . number_format($total_revenue_current_year, 0) . '</h5>';
