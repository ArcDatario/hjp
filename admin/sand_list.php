...
<span style='margin-left:7%;' class='badge bg-danger notif' id='pendingOrdersCount'></span>
				...
				<li>
					<a href="sand_list.php"   class="active">
					<i class='bx bx-list-ul icon'></i>
						Sand  Lists
					</a>
				</li>
...
<img src="" alt="">
    ...
    Swal.fire({
        ...
        html: `
            <form method="post" enctype="multipart/form-data" id="insert_form">
                <div class="form-group">
                    <label for="sand" class="col-form-label">Sand</label>
                    <input type="text" class="form-control" id="sand" name="sand">
                </div>
                <div class="form-group">
                    <label for="rate_per_bucket" class="col-form-label">Rate per Bucket (₱)</label>
                    <input type="number" class="form-control" id="rate_per_bucket" name="rate_per_bucket">
                </div>
                <div class="form-group">
                    <label for="image" class="col-form-label">Sand Image</label>
        ...
        preConfirm: function() {
            ...
            return fetch('functions/insert_sand.php', {
                method: 'POST',
                body: form_data
            })
            .then(response => {
...
$(document).on('click', '#edit_btn', function() {
    ...
    $.ajax({
        url: 'functions/get_sand_details.php',
        type: 'GET',
        data: { id: sandId },
        dataType: 'json',
            ...
            if (sandDetails && Object.keys(sandDetails).length > 0) {
                ...
                Swal.fire({
                    ...
                    <form method="post" enctype="multipart/form-data" id="edit_form">
                        ...
                        <div class="form-group">
                            <label for="edit_sand" class="col-form-label">Sand Type</label>
                            <input type="text" value="${sandDetails.sand}" class="form-control" id="edit_sand" name="sand" required>
                        </div>
                        <div class="form-group">
                            <label for="edit_rate_per_bucket" class="col-form-label">Rate per Bucket (₱)</label>
                            <input type="number" value="${sandDetails.rate_per_bucket}" class="form-control" id="edit_rate_per_bucket" name="rate_per_bucket" required>
                        </div>
                        <div class="form-group">
                            <label for="edit_image" class="col-form-label">Sand Image</label>
...
<script>
     $(document).ready(function(){
        ...
        function fetch_food_menu() {
            $.ajax({
                url: 'functions/get_sand_data.php', // Path to your PHP script fetching recent occupied bookings
                type: 'GET',
                success: function(response) {
                    $('#sand-tbl').html(response);
                }
            });
        }
