	...
	<div class="sidebar transition overlay-scrollbars animate__animated  animate__slideInLeft">
        <div class="sidebar-content"> 
            ...
            <span style='margin-left:7%;' class='badge bg-danger notif' id='pendingCount'></span>
				...
				<li>
					<a href="approve_list.php"  class="active">
					<i class='bx bx-list-ul icon'></i>
						Approved Lists
		...
		<div class="container-fluid dashboard">
            ...
            <div class="col-md-12">
					<div class="card">
						...
						<table class="table table-striped" id="rent_approved_table">
							<thead>
							  <tr>
...
$sql = "SELECT rental.id, equipment_tbl.equipment, rental.rent_start_date, rental.rent_end_date, rental.summary, rental.total, rental.status, users_acc.user_name, rental.downpayment, rental.first_total
FROM rental
INNER JOIN equipment_tbl ON rental.equipment_id = equipment_tbl.id
INNER JOIN users_acc ON rental.user_id = users_acc.id Where status='Approved'";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        <tr>
            ...
            <td><?php echo formatDate($row['rent_start_date']); ?></td>
            <td><?php echo formatDate($row['rent_end_date']); ?></td>
            ...
            <td>
                ...
                onclick="confirmPaid(<?php echo $row['id']; ?> ,<?php echo $row['total']; ?>)"></button>
...
function confirmPaid(equipmentId, Total) {
    // Display SweetAlert2 confirmation modal
    Swal.fire({
        title: 'Are you sure?',
        html: 'You are about to Paid this rent. #<b>' + equipmentId + '</b><br><br>Total: <b style="text-decoration:underline;">₱' + Total + '</b>',
        icon: 'success',
...
function Paid(equipmentId, Total) {
    $.ajax({
        url: 'paid_rent.php',
        type: 'POST',
        data: {
...
Toast.fire({
  icon: "success",
  title: "Rent #"+ equipmentId  + " has been Paid"
})
...
<script>
new DataTable('#rent_approved_table');
</script>
 </body>
</html>
