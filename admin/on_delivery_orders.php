	...
	<div class="sidebar transition overlay-scrollbars animate__animated  animate__slideInLeft">
        <div class="sidebar-content"> 
            ...
            <ul class="side-menu">
				...
				<li>
					<a href="on_delivery_orders.php"  class="active">
					<i class='bx bx-list-ul icon'></i>
...
INNER JOIN users_acc ON orders.user_id = users_acc.id Where status='On Delivery'";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        <tr>
            ...
            <td><span class="" style="color:#138618;"><?php echo $row['status']; ?></span></td>
