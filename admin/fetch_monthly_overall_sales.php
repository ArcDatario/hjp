...
// Output HTML for the revenue display container
echo '<div id="monthly_sales">';
echo '<span class="' . $class . ' small pt-1 fw-bold" style="color:black; float:right; margin-top:14%; font-size:0.8rem;" id="overall_percentage_month">'. $sign . abs($percentage_change) . '%</span>';
echo '<h5 id="overall_sales_month" style="font-size:1.1rem;">₱' . number_format($total_revenue_current_month, 0) . '</h5>';
echo '</div>';
?>
