	...
	<div class="sidebar transition overlay-scrollbars animate__animated  animate__slideInLeft">
        <div class="sidebar-content"> 
            ...
            <ul class="side-menu">
				...
				<li>
					<a href="prepaired_orders.php"  class="active">
					<i class='bx bx-list-ul icon'></i>
...
INNER JOIN users_acc ON orders.user_id = users_acc.id Where status='Preparing'";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        <tr>
            ...
            <td><span class="" style="color:#52AFBF;"><?php echo $row['status']; ?></span></td>
            ...
            <td>
                ...
                onclick="confirmApproval(<?php echo $row['order_id']; ?>)"></button>
...
?>
    ...
    Swal.fire({
        title: 'Are you sure?',
        text: 'You are about to Deliver this Order. #' + orderId ,
        icon: 'success',
...
Toast.fire({
  icon: "success",
  title: "Order #"+ orderId  + " will be deliver"
})
