            ...
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-4 text-center">
                        <img src="images/hjp_remove_bg.png" alt="HJP Logo" height="160" width="160">
                    </div>
                    <div class="col-4" style="text-align:center; float:right; margin-top:-120px; margin-right:240px;">
                         
                       <h4 style="margin-top:12.5%;">Rent Sales Report</h4><br>
                    ...
                    <div class="col-12" style="width:100%; border-bottom:1px solid grey;">
                        <table class="table table-lg" style="font-size:0.9rem; width:100%">
                            <thead style="text-align:left;">
                                <tr><th>Equipment</th><th>Summary</th><th>Status</th><th>Revenue</th><th>Date</th></tr>
                            </thead>
                            <tbody>
                                ${rentalData.map(item => `
                                    <tr>
            ...
            <div class="container">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-4" style="text-align:center; float:right; margin-top:-120px; margin-right:240px;">
                     ...
                     <h4 style="margin-top:12.5%;">Aggregates Sales Report</h4><br>
                        <p style="font-size:0.9rem;">${dateRange}</p>
                    </div>
                    <div class="col-4" style="float:right; margin-top:-140px; margin-left:35%;">
                        <div class="ratings-card">${ratingsCardContent}</div>
                ...
                <div class="row mb-4">
                    <div class="col-12" style="width:100%; border-bottom:1px solid grey;">
                        <table class="table table-lg" style="font-size:0.9rem; width:100%">
                            <thead style="text-align:left;">
                                <tr><th>Sand</th><th>Summary</th><th>Status</th><th>Revenue</th><th>Date</th></tr>
                            </thead>
                            <tbody>
